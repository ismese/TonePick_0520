  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>중요한 보이스</Text>
        <Text style={styles.sectionDesc}>당신이 좋아하는 목소리를 담아봤어요.</Text>
      </View>
